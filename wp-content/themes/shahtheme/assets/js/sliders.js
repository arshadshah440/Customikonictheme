...
jQuery(document).ready(function () {
  horizontalslider("#best_seller_slider_ar", true, 20,0, true, 1, 3, 3);
  horizontalslider("#featured_slider_ar", true, 20,0, true, 1, 3, 3);
  jQuery(".prev_ar").on("click", function () {
    console.log(      jQuery(this).closest("section").find(".owl-carousel").trigger("prev.owl.carousel")
  );
